...
import com.prompt2app.agent.workflow.ai.ImageCollectionPlanService;
import com.prompt2app.agent.workflow.model.ImageCollectionPlan;
import com.prompt2app.agent.workflow.model.ImageResource;
import com.prompt2app.agent.workflow.state.WorkflowContext;
import com.prompt2app.agent.workflow.tools.ImageSearchTool;
import com.prompt2app.agent.workflow.tools.LogoGeneratorTool;
import com.prompt2app.agent.workflow.tools.MermaidDiagramTool;
import com.prompt2app.agent.workflow.tools.UndrawIllustrationTool;
