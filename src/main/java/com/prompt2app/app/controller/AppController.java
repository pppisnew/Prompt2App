...
import com.prompt2app.infra.annotation.AuthCheck;
...
import com.prompt2app.app.model.dto.app.*;
import com.prompt2app.app.model.entity.User;
import com.prompt2app.app.model.vo.AppVO;
import com.prompt2app.infra.ratelimiter.annotation.RateLimit;
import com.prompt2app.infra.ratelimiter.enums.RateLimitType;
import com.prompt2app.app.service.ProjectDownloadService;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.prompt2app.infra.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
